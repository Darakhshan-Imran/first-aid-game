...
//         <p>Help the child with: {subject.name}</p>
//       </div>
//       <div className="flex gap-4">
//         <Droppable droppableId="choices">
//           {(provided) => (
//             <div {...provided.droppableProps} ref={provided.innerRef} className="bg-gray-100 p-4 rounded-lg w-1/2">
...
//               ref={provided.innerRef}
//               className="bg-gray-100 p-4 rounded-lg w-1/2 flex flex-col items-center justify-center"
//             >
//               <Image
